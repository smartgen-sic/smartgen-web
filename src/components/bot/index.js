    ...
    return (
        <body>
            ...
            <div className="pemaparan">
                <p>
                    cara belajarmu sudah keren nihh. Lebih semangat lagi yah
                    sahabat Suzy!
                </p>
            </div>
            <div className="cukup">
            ...
            <div className="ending">
                <img src={lima} alt="baiklah" />
            </div>
            <button type="button" className="button-mulai">
                <p className="mulai kembali sesi curhatmu">
                    {" "}
                    mulai kembali sesi
                </p>
            </button>
